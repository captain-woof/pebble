...
export interface PebbleRoleManagerInterface extends utils.Interface {
  functions: {
...
export interface PebbleRoleManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PebbleRoleManagerInterface;
